# python3 checkmypass.py passwords_to_check
...
def pwned_api_check(requested_password):
    sha1password = hashlib.sha1(requested_password.encode('utf-8')).hexdigest().upper()
